...
//good that I have a working code now
//need to understand this

//what does it do to requests which are not there?
//will try to make a diagram of all of this!!
package main
...
//interesting that it does not reject any requests, really want to understand how - even if queue size is 1?
func main() {
	var (
